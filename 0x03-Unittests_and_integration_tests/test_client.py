...
class TestGithubOrgClient(unittest.TestCase):
    ...
    def test_public_repos(self, mock_get_json: Mock) -> None:
        """Test public_repos"""
        mock_get_json.return_value = [{"name": "repo1", "private": False, "license": {"key": "apache-2.0"}}, {"name": "repo2", "private": False, "license": {"key": "mit"}}]
        with patch(
            ...
            client_instance = GithubOrgClient("google")
            self.assertEqual(client_instance.public_repos(), ["repo1", "repo2"])
...
class TestIntegrationGithubOrgClient(unittest.TestCase):
    ...
    def test_public_repos_with_license(self) -> None:
        ...
        client_instance = GithubOrgClient("google")
        self.assertEqual(
            client_instance.public_repos(license="apache-2.0"), self.apache2_repos
        )
        # Assert that requests.get was called for org_url and repos_url
        calls = self.mock_get.call_args_list
